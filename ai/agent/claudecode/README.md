...
- `lesson:04`: `s03 Permission` in TypeScript with a three-gate permission pipeline.
...
Open [src/lessons/step1/04-permission.ts](src/lessons/step1/04-permission.ts) and try:

1. Change one deny-list pattern.
2. Add a new permission rule.
3. Make the interactive approval path reject by default.
4. Run `npm run lesson:04`.
